...
close all;
generateimages2d('constant2d', @(x,y,n)constantbasis2d(x,y,n,15),225,100);
close all;
generateimages2d('rbf2d', @(x,y,n)rbfbasis2d(x,y,n,15,0.1),225,100);
close all;
generateimages2d('wavelet2d', @(x,y,n)haarwaveletbasis2d(x,y,n),1023,100);
close all;
generateimages2d('poly2d', @(x,y,n)polybasis2d(x,y,n),225,5);
close all;
generateimages2d('cosine2d', @(x,y,n)cosinebasis2d(x,y,n),224,52);
close all;
